...
insert  into `acl_grupo`(`id_acl_grupo`,`nombre`,`fecha_creacion`,`ultima_modificacion`,`activo`,`eliminado`) values (1,'Iron Admin','2014-11-24 19:11:29','2014-11-24 15:19:29','S',0),(2,'Vendedores','2015-03-28 18:03:14','2015-03-28 18:52:14','S',0);
...
insert  into `acl_grupo_permiso`(`id_acl_grupo_permiso`,`fk_acl_grupo`,`fk_acl_permiso`) values (171,1,32),(170,1,28),(169,1,17),(168,1,18),(167,1,19),(166,1,20),(165,1,21),(164,1,22),(163,1,23),(162,1,24),(161,1,25),(160,1,26),(159,1,27),(158,1,13),(157,1,14),(156,1,16),(155,1,3),(154,1,2),(153,1,4),(152,1,5),(151,1,6),(150,1,7),(149,1,9),(148,1,10),(147,1,11),(146,1,12),(145,1,1),(144,1,30),(143,1,29),(206,2,18),(205,2,19),(204,2,20),(203,2,21),(202,2,22),(201,2,23),(200,2,24),(199,2,25),(198,2,26),(197,2,27),(196,2,29),(195,2,30),(207,2,17);
...
insert  into `acl_usuario`(`id_acl_usuario`,`nombre`,`apellido`,`usuario`,`contrasenia`,`email`,`cii`,`bloqueado`,`activo`,`eliminado`) values (1,'Iron','AdminLo','ironadmin','$2a$10$X9mBl1cPM/olzH4QwCdbJ.EUxHSdQT4LTzZGq7U3gCaklr7nqdYXG','example@example.com',NULL,'N','S',0),(2,'soo','soos','ironadmin','$2a$10$RI4A2YTJMU4i1UPPZghoOeqeKlTS6IlQUouZo8PcMTe.v2X9KtNI2','example@example.com',NULL,'N','N',1),(3,'folas','lasas','lllaaa','$2a$10$PLA.BYIhN5AkyrPaIVOsbe7Dj5ZQEH8WIkSztBzEMm/2/XoOi2m1.','example@example.com',NULL,'N','S',0);
...
insert  into `acl_usuario_grupo`(`id_acl_usuario_grupo`,`fk_acl_usuario`,`fk_acl_grupo`) values (1,1,1),(2,1,2),(3,3,2);
